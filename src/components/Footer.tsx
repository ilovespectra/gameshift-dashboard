    ...
    <div className="">
      <footer className="mx-auto  flex flex-row p-2 text-center items-center footer bg-neutral text-neutral-content">
        ...
        <div className="max-w-md mx-auto sm:pl-12 grid-flow-col gap-4 text-center">
          <a href="https://github.com/ilovespectra/gameshift-dashboard" target="_blank" rel="noopener noreferrer">
          ...
          <a href="https://www.solarplex.xyz/profile/tanny.live.solarplex.xyz" target="_blank" rel="noopener noreferrer">
